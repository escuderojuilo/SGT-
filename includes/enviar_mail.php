...
//Create an instance; passing `true` enables exceptions
    ...
    try {
        ...
        $mail->Subject = "Bienvenido/a al Sistema de Cursos";
...
<body>
    <div class="container">
        <div class="header">
            <h1>¡Bienvenid@ al Sistema de Cursos!</h1>
        </div>
        <div class="content">
            <h2>Hola, ' . htmlspecialchars($nombre) . ' 👋</h2>
            <p>Nos complace darte la bienvenida a nuestra plataforma. A continuación encontrarás tus <strong>credenciales de acceso</strong>:</p>
